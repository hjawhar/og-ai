...
export interface RebuildRequest {
	...
	/** Model key to make active; omit to keep the current one. */
	model?: string;
}
...
export interface RebuildResult {
	agent: Agent;
	sessionId: string;
	/** Active model key after the rebuild. */
	model: string;
}

/**
 * Everything a UI surface needs. The four required members are the stable
